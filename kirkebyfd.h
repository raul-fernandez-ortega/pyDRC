...
/* Inversione tramite Kirkeby fast deconvolution */
bool KirkebyFDInvert(const DLReal * InSig, int InSigLen,DLReal * InvFilter, int InvFilterLen, const DLReal * EffortSig, 
...
bool PEISMPKirkebyFDInvert(const DLReal * MPSig, int MPSigLen, const DLReal * EPSig, int EPSigLen, DLReal * InvFilter, 
			   int InvFilterLen, DLReal EffortFactor, int MExp);

/* Inversione tramite selective minimum pahse fast deconvolution */
/* Versione a misura diretta degli effetti di pre echo */
bool PEMSMPKirkebyFDInvert(const DLReal * MPSig, int MPSigLen, const DLReal * EPSig, int EPSigLen, DLReal * InvFilter, 
			   int InvFilterLen, DLReal EffortFactor, int PEStart, int PETransition, int MExp);
