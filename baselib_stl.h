...
bool STL_WriteSignal(const char * FName,const STLvectorReal Src,
		     const unsigned int WStart, const unsigned int WLen, const IFileType FType);
...
STLvectorReal STL_AutoCorrelation(const STLvectorReal S);
...
STLvectorReal STL_GroupDelay(const STLvectorReal S);
